...
script_dir = Path(os.getcwd())  # or paste the known folder path directly
path_out = str(script_dir.parent / "00_pipeline_data" ) + "/"
...
output_file = path_out + f"forecast_raw_icon_ch2_2kmRegCons_daily_00utc_data.nc"
...
t2m_r.to_netcdf(output_file, encoding=time_encoding)
ds_native.close()
